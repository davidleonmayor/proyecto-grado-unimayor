...
function SocialOutreachExtraction() {
  ...
  const handleSaveToDatabase = async () => {
    try {
      ...
      const defaultName =
        outreach.extractedData[0]?.titulo?.trim() ||
        "proyecto proyeccion social";
      ...
      console.log("handleSaveToDB antes de enviar al backend:", {
        file: generatedFile,
        nombre: nombre.trim(),
  ...
  return (
    <TooltipProvider>
      ...
      >
        {/* Left Panel */}
        <div className="flex-shrink-0 flex flex-col h-1/2 md:h-full w-full md:w-[var(--left-width)] overflow-hidden relative z-0 border-b md:border-b-0 md:border-r">
