...
export default function ProjectDetailPage() {
  ...
  const [statuses, setStatuses] = useState<
    Array<{ id_estado_tg: string; nombre_estado: string }>
  >([]);
  ...
  const handleReview = async (e: React.FormEvent) => {
    ...
    try {
      ...
      Swal.fire(
        "Error",
        error instanceof Error ? error.message : "Error al registrar revisión",
        "error",
      );
    } finally {
          ...
          <div className="max-w-2xl mx-auto space-y-8">
            ...
            {/* <form onSubmit={handleReview} className="space-y-5">
                ...
                <div>
                  ...
                  {loadingStatuses ? (
                    ...
                    >
                      ...
                      {statuses.map((status) => (
                        <option
                          key={status.id_estado_tg}
                          value={status.id_estado_tg}
                        >
                  ...
                  <p className="text-[11px] text-gray-500 mt-1">
                    "Información General" registra el cambio sin afectar el
                    estado actual.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div
                  className={`relative group border-2 border-dashed rounded-lg p-6 text-center transition-all ${reviewFile ? "border-gray-800 bg-gray-50" : "border-gray-200 hover:border-gray-400 bg-white"}`}
                >
                  <input
                    type="file"
                    onChange={(e) => {
                  ...
                  {!reviewFile ? (
                    <div className="space-y-2 pointer-events-none">
                      <svg
                        className="mx-auto h-6 w-6 text-gray-400 group-hover:text-gray-600 transition-colors"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
