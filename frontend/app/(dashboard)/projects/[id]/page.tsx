...
export default function ProjectDetailPage() {
    ...
    // Upload State - DISABLED FOR STUDENTS
    ...
    // handleUpload - DISABLED FOR STUDENTS
    ...
    return (
        <div className="p-6 max-w-5xl mx-auto">
            ...
            <div className="flex border-b border-gray-200 mb-6">
                ...
                {/* Upload tab disabled for students - they can only view history */}
                {isPrivileged && (
                    <button
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 min-h-[400px]">
                ...
                {/* Upload Tab (Student) - DISABLED */}
                {/* Students can only view history, they cannot upload files */}
