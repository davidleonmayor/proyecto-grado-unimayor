            ...
            <div className="flex justify-between items-center mb-6">
                ...
                {isPrivileged && (
                    <Link
                        ...
                        className="bg-gradient-to-r from-primary-600 to-secondary-500 text-white px-4 py-2 rounded-lg hover:from-primary-700 hover:to-secondary-600 transition-all font-medium flex items-center gap-2 shadow-md hover:shadow-lg transform hover:scale-105"
                    >
