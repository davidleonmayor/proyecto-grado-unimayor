        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-start max-w-5xl mx-auto">
          <div className="flex-1 space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1 leading-relaxed">
                Importa múltiples proyectos mediante un archivo Excel (.xlsx,
                .xls).
              </p>
            </div>
            ...
            <div className="text-xs text-gray-500 bg-gray-50 p-4 rounded-md border border-gray-100 space-y-2">
              <p>
                ...
                Titulo, Modalidad, Estado, Programa, Fecha_inicio, Estudiantes.
              </p>
              <p>
                <span className="font-semibold text-gray-700">
                  Columnas opcionales:
                </span>{" "}
                Resumen, Objetivos, Empresa, Fecha_fin, Asesores.
              </p>
              <p>
                <span className="font-semibold text-gray-700">Formato:</span>{" "}
                Fechas AAAA-MM-DD. Listas separadas por (;). Máx. 2
          ...
          <div className="w-full md:w-[380px] flex flex-col gap-4">
            <div className="relative group">
              <div
                className={`border-2 border-dashed rounded-lg p-6 text-center transition-all ${selectedFile ? "border-gray-800 bg-gray-50" : "border-gray-200 hover:border-gray-400 bg-white"}`}
              >
                <input
                  id="bulk-upload"
                  ref={fileInputRef}
                ...
                {!selectedFile ? (
                  <div className="space-y-2 pointer-events-none">
                    <svg
                      className="mx-auto h-8 w-8 text-gray-400 group-hover:text-gray-600 transition-colors"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
