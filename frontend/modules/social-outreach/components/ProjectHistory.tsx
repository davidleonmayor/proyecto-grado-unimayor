            ...
            <div className="flex justify-between items-start mb-2">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Por <span className="font-medium">{item.user}</span> (
                  {item.role})
                </p>
              </div>
                  ...
                  <div className="mb-3">
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-2 h-2 rounded-full ${fromColor.dot}`}
                        ></div>
                        <span
                          className={`text-sm font-medium ${fromColor.text}`}
                        >
                      ...
                      <div className="flex items-center gap-2">
                        <div
                          className={`w-2 h-2 rounded-full ${toColor.dot}`}
                        ></div>
                        <span
                          className={`text-sm font-semibold ${toColor.text}`}
                        >
