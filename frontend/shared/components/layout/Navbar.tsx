      ...
      <div className="flex items-center gap-6 justify-end w-full relative z-50">
        ...
        <div className="relative" ref={messagesRef}>
          ...
          >
            ...
            />
            {unreadCount > 0 && (
              <div className="absolute -top-1.5 -right-1 w-5 h-5 flex items-center justify-center bg-blue-500 text-white rounded-full text-[10px] font-bold shadow-sm ring-2 ring-white">
                {unreadCount}
              </div>
            )}
          </div>
            ...
            <div className="absolute right-0 mt-3 w-80 bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] py-0 z-50 border border-gray-100 overflow-hidden flex flex-col">
              ...
              {loading ? (
                ...
                <div className="px-5 py-10 flex flex-col items-center justify-center text-center bg-white">
                  ...
                  <p className="text-[12px] text-gray-400 mt-1.5 leading-relaxed font-light">
                    Inicia una conversación con
                    <br />
                    alguien de tu facultad.
                  </p>
                </div>
              ) : (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-center mb-0.5">
                          <h4
                            className={`text-[13px] leading-snug truncate ${conv.unreadCount > 0 ? "font-semibold text-gray-900" : "font-medium text-gray-700"}`}
                          >
                            {conv.peerName}
                          </h4>
                        ...
                        <p
                          className={`text-[12px] line-clamp-1 leading-relaxed ${conv.unreadCount > 0 ? "text-gray-700 font-medium" : "text-gray-500 font-light"}`}
                        >
                          {conv.lastMessageIsMine ? "Tú: " : ""}
                          {conv.lastMessage}
                        </p>
                      </div>
                      {conv.unreadCount > 0 && (
                        <div className="w-5 h-5 flex items-center justify-center bg-primary-500 text-white rounded-full text-[10px] font-bold shrink-0">
                          {conv.unreadCount}
                        </div>
                      )}
                    </div>
          ...
          {/* {showAnnouncements && (
            <div className="absolute right-0 mt-3 w-80 bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] py-0 z-50 border border-gray-100 overflow-hidden flex flex-col">
              <div className="px-5 py-4 border-b border-gray-50 flex justify-between items-center bg-slate-50/50">
                ...
                <span className="text-[11px] font-medium text-gray-400 cursor-pointer hover:text-gray-700 transition-colors">
                  Marcar como leídas
                </span>
              </div>
              ...
              <div className="flex flex-col max-h-[320px] overflow-y-auto">
                <div className="px-5 py-4 cursor-pointer border-l-[3px] border-amber-400 bg-amber-50/30 hover:bg-amber-50/60 transition-colors">
                  <div className="flex justify-between items-start mb-1.5 gap-2">
                    <h4 className="text-[13px] font-medium text-gray-800 leading-snug">
                      Actualización de Listados
                    </h4>
                    <span className="text-[10px] font-medium text-amber-600 whitespace-nowrap bg-amber-100/50 px-1.5 py-0.5 rounded">
                      Nuevo
                    </span>
                  </div>
                  <p className="text-[12px] text-gray-500 line-clamp-2 leading-relaxed font-light">
                    Hemos implementado mejoras visuales en todas las tablas de
                    proyectos. Ahora puedes gestionar...
                  </p>
                ...
                <div className="px-5 py-4 hover:bg-slate-50 transition-colors cursor-pointer border-l-[3px] border-transparent border-t border-gray-50">
                  <div className="flex justify-between items-start mb-1.5">
                    <h4 className="text-[13px] font-medium text-gray-700 leading-snug">
                      Bienvenido al nuevo sistema
                    </h4>
                  </div>
                  <p className="text-[12px] text-gray-500 line-clamp-2 leading-relaxed font-light">
                    Gracias por conectarte a la nueva plataforma de
                    administración de proyectos del Colegio Mayor...
                  </p>
                  <span className="text-[10px] text-gray-400 mt-2 block font-light">
                    Hace 3 días
                  </span>
