...
const responseSchemas = {
  ProyeccionSocialItem: {
    ...
    properties: {
      ...
      resumen: { type: "string", nullable: true, maxLength: 200 },
    },
  },
    ...
    allOf: [
      { $ref: "#/components/schemas/ProyeccionSocialItem" },
      {
        ...
        properties: {
          ...
          palabras_clave: { type: "string", nullable: true, maxLength: 100 },
          identificacion_problematica: { type: "string", nullable: true, maxLength: 1000 },
          propuesta_solucion: { type: "string", nullable: true, maxLength: 700 },
          caracterizacion_poblacion: { type: "string", nullable: true, maxLength: 900 },
          objetivos: { type: "string", nullable: true, maxLength: 900 },
          resultados_esperados: { type: "string", nullable: true, maxLength: 700 },
          metodologia: { type: "string", nullable: true, maxLength: 1000 },
          bibliografia: { type: "string", nullable: true, maxLength: 600 },
        },
      },
    ],
  },
