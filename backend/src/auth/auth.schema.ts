...
export const RegisterSchema: Schema = {
  ...
  typeOfDentityDocument: {
    ...
    isLength: {
      options: { min: 1, max: 50 },
      errorMessage: "typeOfDentityDocument must be between 1 and 50 characters",
    },
    trim: true,
  },
  idDocumentNumber: {
    ...
    isLength: {
      ...
      errorMessage: "idDocumentNumber must be between 5 and 50 characters",
    },
    trim: true,
  },
  phoneNumber: {
...
export const UserConfirmationSchema: Schema = {
  token: {
    ...
    isLength: {
      options: { min: 6, max: 6 },
      errorMessage: "Token must be exactly 6 characters",
    },
    trim: true,
    toUpperCase: true,
  },
...
export const ValidateTokenSchema: Schema = {
  token: {
    ...
    matches: {
      options: /^[0-9]+$/,
      errorMessage: "phoneNumber must contain only 6 digits",
    },
    isString: {
      errorMessage: "Token must be a string",
    },
