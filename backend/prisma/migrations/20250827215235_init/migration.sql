/*
  ...
  - You are about to drop the `DL_ASIGNACION_ASESOR` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_ASIGNACION_JURADO` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_CONSEJO_FACULTAD` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_DET_PRACT_PROF` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_DOCENTE` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_DOC_ADJ_TRG` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_EMPRESA` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_ESTADO_TG` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_ESTUDIANTE` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_EST_EST_TG` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_FACULTAD` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_HIST_ESTADO_TG` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_OFICIO` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_OPCION_GRADO` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_PROGRAMA_ACADEMICO` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_SUSTENTACION` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `DL_TRABAJO_GRADO` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE `DL_ASIGNACION_ASESOR` DROP FOREIGN KEY `DL_ASIGNACION_ASESOR_id_docente_asesor_fkey`;

-- DropForeignKey
ALTER TABLE `DL_ASIGNACION_ASESOR` DROP FOREIGN KEY `DL_ASIGNACION_ASESOR_id_trabajo_grado_fkey`;

-- DropForeignKey
ALTER TABLE `DL_ASIGNACION_JURADO` DROP FOREIGN KEY `DL_ASIGNACION_JURADO_id_docente_jurado_fkey`;

-- DropForeignKey
ALTER TABLE `DL_ASIGNACION_JURADO` DROP FOREIGN KEY `DL_ASIGNACION_JURADO_id_trabajo_grado_fkey`;

-- DropForeignKey
ALTER TABLE `DL_DET_PRACT_PROF` DROP FOREIGN KEY `DL_DET_PRACT_PROF_id_empresa_fkey`;

-- DropForeignKey
ALTER TABLE `DL_DET_PRACT_PROF` DROP FOREIGN KEY `DL_DET_PRACT_PROF_id_trabajo_grado_fkey`;

-- DropForeignKey
ALTER TABLE `DL_DOC_ADJ_TRG` DROP FOREIGN KEY `DL_DOC_ADJ_TRG_id_historial_fkey`;

-- DropForeignKey
ALTER TABLE `DL_ESTUDIANTE` DROP FOREIGN KEY `DL_ESTUDIANTE_id_programa_academico_fkey`;

-- DropForeignKey
ALTER TABLE `DL_EST_EST_TG` DROP FOREIGN KEY `DL_EST_EST_TG_id_estudiante_fkey`;

-- DropForeignKey
ALTER TABLE `DL_EST_EST_TG` DROP FOREIGN KEY `DL_EST_EST_TG_id_trabajo_grado_fkey`;

-- DropForeignKey
ALTER TABLE `DL_HIST_ESTADO_TG` DROP FOREIGN KEY `DL_HIST_ESTADO_TG_id_consejo_facultad_fkey`;

-- DropForeignKey
ALTER TABLE `DL_HIST_ESTADO_TG` DROP FOREIGN KEY `DL_HIST_ESTADO_TG_id_estado_tg_fkey`;

-- DropForeignKey
ALTER TABLE `DL_HIST_ESTADO_TG` DROP FOREIGN KEY `DL_HIST_ESTADO_TG_id_trabajo_grado_fkey`;

-- DropForeignKey
ALTER TABLE `DL_OFICIO` DROP FOREIGN KEY `DL_OFICIO_id_historial_fkey`;

-- DropForeignKey
ALTER TABLE `DL_OPCION_GRADO` DROP FOREIGN KEY `DL_OPCION_GRADO_id_programa_academico_fkey`;

-- DropForeignKey
ALTER TABLE `DL_PROGRAMA_ACADEMICO` DROP FOREIGN KEY `DL_PROGRAMA_ACADEMICO_id_facultad_fkey`;

-- DropForeignKey
ALTER TABLE `DL_SUSTENTACION` DROP FOREIGN KEY `DL_SUSTENTACION_id_trabajo_grado_fkey`;

-- DropForeignKey
ALTER TABLE `DL_TRABAJO_GRADO` DROP FOREIGN KEY `DL_TRABAJO_GRADO_id_estado_actual_fkey`;

-- DropForeignKey
ALTER TABLE `DL_TRABAJO_GRADO` DROP FOREIGN KEY `DL_TRABAJO_GRADO_id_opcion_grado_fkey`;

-- DropTable
DROP TABLE `DL_ASIGNACION_ASESOR`;

-- DropTable
DROP TABLE `DL_ASIGNACION_JURADO`;

-- DropTable
DROP TABLE `DL_CONSEJO_FACULTAD`;

-- DropTable
DROP TABLE `DL_DET_PRACT_PROF`;

-- DropTable
DROP TABLE `DL_DOCENTE`;

-- DropTable
DROP TABLE `DL_DOC_ADJ_TRG`;

-- DropTable
DROP TABLE `DL_EMPRESA`;

-- DropTable
DROP TABLE `DL_ESTADO_TG`;

-- DropTable
DROP TABLE `DL_ESTUDIANTE`;

-- DropTable
DROP TABLE `DL_EST_EST_TG`;

-- DropTable
DROP TABLE `DL_FACULTAD`;

-- DropTable
DROP TABLE `DL_HIST_ESTADO_TG`;

-- DropTable
DROP TABLE `DL_OFICIO`;

-- DropTable
DROP TABLE `DL_OPCION_GRADO`;

-- DropTable
DROP TABLE `DL_PROGRAMA_ACADEMICO`;

-- DropTable
DROP TABLE `DL_SUSTENTACION`;

-- DropTable
DROP TABLE `DL_TRABAJO_GRADO`;
